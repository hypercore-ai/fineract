...
public final class LoanAccountData {
    ...
    private final BigDecimal minFloatingRateInterest;
    ...
    private LoanAccountData(EnumOptionData loanType, Long clientId, Long productId, Long loanOfficerId, LocalDate submittedOnDate,
        ...
        this.minFloatingRateInterest = null;
        this.activateOnApproval = false;
    ...
    public static LoanAccountData collateralTemplate(final Collection<CodeValueData> loanCollateralOptions) {
        ...
        final BigDecimal minFloatingRateInterest = null;
        final Boolean activateOnApproval = false;

        final boolean isRevolving = false;
        final LocalDate revolvingPeriodStartDate = null;
        final LocalDate revolvingPeriodEndDate = null;
        final LoanScheduleData initialExpectedSchedule = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                activateOnApproval, isRevolving, revolvingPeriodStartDate, revolvingPeriodEndDate, initialExpectedSchedule, overrideInterestAmountVariations);
    ...
    public static LoanAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
            ...
            final BigDecimal topupAmount, final boolean isEqualAmortization, final BigDecimal minFloatingRateInterest,
            final Boolean activateOnApproval, final boolean isRevolving, final LocalDate revolvingPeriodStartDate,
    ...
    public static LoanAccountData associationsAndTemplate(final LoanAccountData acc, final LoanScheduleData repaymentSchedule,
            ...
            final Collection<LoanAccountSummaryData> clientActiveLoanOptions, final List<RateData> rates, final Boolean isRatesEnabled,final Collection<LoanTermVariationsData> overrideInterestAmountVariations) {
