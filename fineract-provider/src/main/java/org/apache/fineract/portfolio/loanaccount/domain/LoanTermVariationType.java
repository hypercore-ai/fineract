...
public enum LoanTermVariationType {
    ...
    public static LoanTermVariationType fromInt(final Integer value) {
        ...
        switch (value) {
            ...
            break;
            case 11:
                enumeration = LoanTermVariationType.OVERRIDE_INTEREST_RATE;
            break;
        }
        return enumeration;
    }
    ...
    public boolean isOverrideInterestRate() {
        return this.value.equals(LoanTermVariationType.OVERRIDE_INTEREST_RATE.getValue());
    }
}
